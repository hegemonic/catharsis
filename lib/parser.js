  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "typeParameterList": parse_typeParameterList,
      ...
      function parse_typeExpression() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, modifier, type) {
        		var result = type;
      ...
      function parse_functionSignatureType() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, sig, funcReturns) {
        		var result = {};
        		...
        		if (funcReturns[3]) {
        			result.funcReturns = funcReturns[3];
        		}
      ...
      function parse_functionSignature() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, funcParams) {
        		return {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, funcNew, funcThis, funcParams) {
          		var result = {
          			parameters: funcParams !== '' ? funcParams[3] : [],
          			funcNew:    funcNew
          		};
          		if (funcThis !== '') {
          			result.funcThis = funcThis[3];
          		}
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, funcThis, funcNew, funcParams) {
            		var result = {
            			parameters: funcParams !== '' ? funcParams[3] : [],
            			funcThis:   funcThis
            		};
            		if (funcNew !== '') {
            			result.funcNew = funcNew[3];
            		}
      ...
      function parse_functionSignatureNew() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, id, props) { return id + props; })(pos0, result0[4], result0[5]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_typeParameterList() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, id, list) {
        		var result = [id];
        		for (var i = 0, l = list.length; i < l; i++) {
        			result.push(list[i][3]);
        		}
      ...
      function parse_fieldType() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, expr) {
        		var result = {
        			name: name.name || name,
        			typeName: expr[3] && expr[3].typeName && expr[3].typeName !== '' ? expr[3].typeName :
        				undefined
        		};
      ...
      function parse_parameterType() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, id, expr) {
        		expr.name = id !== '' ? id[0] : undefined;
        		return expr;
        	})(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
