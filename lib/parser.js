...
function peg$parse(input, options) {
  ...
  const peg$e23 = peg$literalExpectation("break", false);
  const peg$e24 = peg$literalExpectation("case", false);
  const peg$e25 = peg$literalExpectation("catch", false);
  const peg$e26 = peg$literalExpectation("continue", false);
  const peg$e27 = peg$literalExpectation("debugger", false);
  const peg$e28 = peg$literalExpectation("default", false);
  const peg$e29 = peg$literalExpectation("delete", false);
  const peg$e30 = peg$literalExpectation("do", false);
  const peg$e31 = peg$literalExpectation("else", false);
  const peg$e32 = peg$literalExpectation("finally", false);
  ...
  const peg$e36 = peg$literalExpectation("instanceof", false);
  const peg$e37 = peg$literalExpectation("return", false);
  const peg$e38 = peg$literalExpectation("switch", false);
  const peg$e39 = peg$literalExpectation("throw", false);
  const peg$e40 = peg$literalExpectation("try", false);
  const peg$e41 = peg$literalExpectation("typeof", false);
  const peg$e42 = peg$literalExpectation("var", false);
  const peg$e43 = peg$literalExpectation("void", false);
  const peg$e44 = peg$literalExpectation("while", false);
  const peg$e45 = peg$literalExpectation("with", false);
  const peg$e46 = peg$literalExpectation("class", false);
  const peg$e47 = peg$literalExpectation("const", false);
  const peg$e48 = peg$literalExpectation("enum", false);
  const peg$e49 = peg$literalExpectation("export", false);
  const peg$e50 = peg$literalExpectation("extends", false);
  const peg$e51 = peg$literalExpectation("import", false);
  const peg$e52 = peg$literalExpectation("super", false);
  const peg$e53 = peg$literalExpectation("implements", false);
  const peg$e54 = peg$literalExpectation("interface", false);
  const peg$e55 = peg$literalExpectation("let", false);
  const peg$e56 = peg$literalExpectation("package", false);
  const peg$e57 = peg$literalExpectation("private", false);
  const peg$e58 = peg$literalExpectation("protected", false);
  const peg$e59 = peg$literalExpectation("public", false);
  const peg$e60 = peg$literalExpectation("static", false);
  const peg$e61 = peg$literalExpectation("yield", false);
  const peg$e62 = peg$literalExpectation("\"", false);
  const peg$e63 = peg$literalExpectation("'", false);
  const peg$e64 = peg$literalExpectation("0", false);
  const peg$e65 = peg$classExpectation(["e", "E"], false, false, false);
  const peg$e66 = peg$classExpectation(["+", "-"], false, false, false);
  const peg$e67 = peg$classExpectation(["x", "X"], false, false, false);
  const peg$e68 = peg$literalExpectation("null", false);
  const peg$e69 = peg$literalExpectation("undefined", false);
  ...
  function peg$f63(lit) {
    return -lit
  }
  function peg$f64(lit, digits, exp) {
    return parseFloat(lit + '.' + (digits || '') + (exp || ''));
  }
  function peg$f65(digits, exp) {
    return parseFloat('.' + digits + (exp || ''));
  }
  function peg$f66(lit, exp) {
    return parseFloat(lit + (exp || ''));
  }
  function peg$f67(hex) {
  ...
  function peg$f76(hex) {
    return String.fromCharCode(parseInt('0x' + hex), 16);
  }
  function peg$f77(seq) {
    return seq;
  }
  ...
  function peg$parseNumericLiteral() {
    ...
    s0 = peg$parseSignedDecimalLiteral();
    if (s0 === peg$FAILED) {
